...
import sys
sys.path.append('/home/asap/.local/lib/python3.5/site-packages')
import os
...
class PSPNet(object):
    ...
    def predict(self, img, flip_evaluation=False):
        ...
        if img.shape[0:2] != (h_ori, w_ori):  # upscale prediction if necessary
            h, w = probs.shape[:2]
...
if __name__ == "__main__":
    ...
    with sess.as_default():
        ...
        for i, img_path in enumerate(images):
            ...
            #io.savemat('1.mat', {'x':cm})
            color_cm = utils.color_class_image(cm, model_name='cityscapes')
